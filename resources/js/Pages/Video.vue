        ...
        <div class="xl:flex">
            <div class="p-3">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <!-- Image ( component from video card )  -->
                
                        <img class="rounded-full m-1.5 mt-2 flex items-baseline w-8 h-8" :src="`https://picsum.photos/id/${(Math.random()*100).toFixed(0)}/100` || ''" alt="" />
                  
                    <div class="pl-2 mt-1">
                        <div class=" text-white text-lg font-extrabold flex  items-center ">{{ video.user }} 
...
<!--  Descriptionn section -->
                <div class="bg-[#3F3F3F] rounded-lg w-full p-3 text-white">
                        <div class="text-white text-lg font-extrabold">
                            ...
                            <div class="text-sm font-extrabold">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus quaerat facilis eos. Hic natus doloremque, neque aliquid eius perferendis qui?
                            </div>
                ...
                <div class="w-[500px] p-3  sm:hidden">
