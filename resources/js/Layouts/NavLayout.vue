...
<template>
    <div class="relative">
            ...
            <div class="flex items-center">
                 <button @click="isNavOverlay()" class="p-2 ml-3 rounded-full hover:bg-gray-800 inline-block cursor-pointer">
                    ...
                    <Link :href="route('home')" class="flex text-white items-center justify-center mr-10 cursor-pointer">
                        <img src="/images/YT-logo.png" alt="" width="32">
                        <img src="/images/YT-logo-text.png" alt="" width="62">
                    </Link>
                </div>

                <div class="w-[600px] md:block hidden">
                    <div class="rounded-full flex items-center bg-[#222222]">
                        <input type="text" name="" id="" class="form-control block w-full px-5 py-1.5 text-base font-normal text-gray-200 bg-black placeholder-gray-400 bg-clip-padding border border-solid border-l-gray-700 border-y-gray-700 rounded-l-full transition ease-in-out m-0 border-transparent focus:ring-0 " placeholder="Search">
                        <MagnifyIcon class="mx-6" fillColor = "#FFFFFF" :size="23"/>
                    </div>
                </div>
                <div>
                    <img class="rounded-full mx-8" width="35" src="https://yt3.ggpht.com/ytc/AL5GRJWhipkBtjwc3MyvNEd0hNoEDPBa-iBK5FhrxDZ0Q8NsEU1_hOGbNOOoFmP6OuSV=s108-c-k-c0x00ffffff-no-rj" alt="">
                </div> 
        ...
        <div @click = "openSideNavOverlay = false" class="bg-black bg-opacity-70 fixed z-50 w-full h-screen" :class="openSideNavOverlay ? 'animate__animated animate__fadeIn animate__faster' : 'hidden z-[-1]'" >

        </div>
        <!-- overlay  -->
        <div >
            <div  id="SideNavOverlay" ref="sideNavOverlay" class="h-[100%] fixed z-50 bg-black w-[240px] mt-[9px]" :class="[openSideNavOverlay ? 'animate__animated animate__slideInLeft animate__faster ' : 'animate__animated animate__slideOutLeft animate__faster ' ]">
        ...
        <div class="w-[100%] h-[calc(100vh-60x)] absolute right-0 top-[60px]"
        :class="{'w-[calc(100%-70px)]' :!openSideNav,
